...
Visuals: Recharts for panels, Leaflet for maps. LogoMark (mascot) for Login/404, LogoWordmark (SVG) for nav.
...
- [Dashboard Panels](mem://features/dashboard-panels) — Specifications for the 12 live dashboard panels (CSS-columns masonry layout)
- [Future Enhancements](mem://future-enhancements) — Specced but not-yet-built features (grid BA map, Kp 3-day trend)
